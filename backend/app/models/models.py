...
class FacebookPage(Base):
    ...
    ai_knowledge_base = Column(String, nullable=True)
    ...
    message_history_turn_limit = Column(Integer, default=5, nullable=False)
    message_reply_min_delay_seconds = Column(Integer, default=3, nullable=False)
    message_reply_max_delay_seconds = Column(Integer, default=5, nullable=False)
    message_typing_indicator_enabled = Column(Boolean, default=True, nullable=False)
    handoff_keywords = Column(String, nullable=True)
...
class InteractionLog(Base):
    ...
    reply_mode = Column(String, default="ai", nullable=False)
    ai_reply = Column(String, nullable=True)
    facebook_reply_comment_id = Column(String, nullable=True)
...
class InboxMessageLog(Base):
    ...
    sender_name = Column(String, nullable=True)
    recipient_id = Column(String, nullable=True)
    reply_to_message_log_id = Column(Uuid(as_uuid=True), ForeignKey("inbox_message_logs.id"), nullable=True, index=True)
    user_message = Column(String)
    ai_reply = Column(String, nullable=True)
